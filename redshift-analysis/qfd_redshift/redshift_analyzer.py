...
class RedshiftAnalyzer:
    ...
    def generate_hubble_diagram(
        self, z_min: float = 0.01, z_max: float = 0.6, n_points: int = 100
    ) -> Dict:
        """
    ...
    def compare_with_lambda_cdm(
        self, omega_m: float = 0.3, omega_lambda: float = 0.7
    ) -> Dict:
        """
        ...
        comparison["lambda_cdm_magnitudes"] = np.array(
            comparison["lambda_cdm_magnitudes"]
        )
        comparison["magnitude_differences"] = (
            comparison["qfd_magnitudes"] - comparison["lambda_cdm_magnitudes"]
        )
    ...
    def create_analysis_plots(self, output_dir: str = "results") -> None:
        ...
        self.plotter.plot_comprehensive_analysis(
            self.results, save_path=output_path / "comprehensive_analysis.png"
        )

    def save_results(
        self, output_file: str = "results/qfd_redshift_results.json"
    ) -> None:
        """
    ...
    def run_complete_analysis(self, output_dir: str = "results") -> Dict:
        ...
        print(
            f"RMS difference vs ΛCDM: "
            f"{lambda_cdm_comparison['rms_difference']:.3f} mag"
        )
