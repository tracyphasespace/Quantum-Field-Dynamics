...
class LeptonEnergy:
    ...
    def total_energy(self, R, U, amplitude, return_profiles=False):
        ...
        if return_profiles:
            # Return density deficit profile and r grid for radius calculation
            delta_rho_profile = density.delta_rho(self.r)
            return E_total, E_circ, delta_rho_profile, self.r
        else:
