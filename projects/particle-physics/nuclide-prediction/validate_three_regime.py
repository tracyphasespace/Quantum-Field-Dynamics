...
Compares:
    1. Single backbone (Phase 1 parameters)
    2. Three-regime model (EM parameters)

Metrics:
    - Accuracy
    - Precision/Recall for stable isotopes
...
# Navigate up to QFD_SpectralGap root
...
def main():
    ...
    print("=" * 80)
    print("Three-Regime Decay Prediction Validation")
    print("=" * 80)

    # Load data
    df = load_nubase_data("NuMass.csv")
    ...
    result_three.to_csv("three_regime_predictions.csv", index=False)
    print(f"✓ Saved detailed predictions to three_regime_predictions.csv")
