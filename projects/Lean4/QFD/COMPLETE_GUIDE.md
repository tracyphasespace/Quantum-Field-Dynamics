...
The QFD Proof Index is a **traceability system** that makes the repository self-describing. With 322 proven theorems and lemmas across 77 files, the limiting factor is no longer mathematical capability—it's **answering questions like**:
...
**Purpose**: Complete, grep-able list of all 322 proven theorems and lemmas.

**Contents**:
- Organized by file and category
- Format: `File:LineNumber:TheoremName`
- Includes summary statistics (243 theorems, 79 lemmas = 322 total)
...
3. **`CLAIMS_INDEX.txt`** (1 min skim)
   - Get a sense of scale (322 proven theorems and lemmas)
...
2. `PROOF_INDEX_GUIDE.md` (overview section) - "322 proven theorems/lemmas across 77 files"
