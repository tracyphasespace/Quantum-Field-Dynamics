...
offset between V22 (β ≈ 3.15) and Golden Loop (β = 3.043233053).
...
V22 model (ξ=0) compensated by inflating β from 3.043233053 to 3.15.
Including ξ breaks the (β, R) degeneracy and validates β = 3.043233053 from α.
