...
## **QFD Engine Visualizations**

### <a href="https://tracyphasespace.github.io/Quantum-Field-Dynamics/visualizations/qfd_engine.html" target="_blank">`qfd_engine.html`</a>
**QFD Engine — Parameter Dashboard**
- 21 interdependent parameters derived from vacuum stiffness beta
- Interactive parameter exploration
- **Suitable for**: Understanding the QFD derivation chain

### <a href="https://tracyphasespace.github.io/Quantum-Field-Dynamics/visualizations/qfd_engine4.html" target="_blank">`qfd_engine4.html`</a>
**QFD Zero-Parameter Engine (Audit Build)**
- Golden Loop derivation: alpha -> beta -> all nuclear parameters
- Zero free parameters — every constant derived from alpha = 1/137.036
- Audit-ready presentation of the complete derivation chain
- **Suitable for**: Reviewers, auditors, replication verification

### <a href="https://tracyphasespace.github.io/Quantum-Field-Dynamics/visualizations/qfd_Constants_engine.html" target="_blank">`qfd_Constants_engine.html`</a>
**QFD Constants Engine**
- Interactive constants derivation and exploration
- **Suitable for**: Understanding fundamental constant relationships

---

## ⚛️ **Nuclear Physics Visualizations**

### <a href="https://tracyphasespace.github.io/Quantum-Field-Dynamics/visualizations/nuclear-physics/nuclide_viewer.html" target="_blank">`nuclide_viewer.html`</a>
**Interactive Nuclide Viewer**
- Full chart of 4,948 nuclides with predicted decay modes and half-life clocks
- Species statistics, per-channel R² scores, and solve rates
- Generated by the Three-Layer LaGrangian pipeline
- **Suitable for**: Nuclear physics research, data exploration
